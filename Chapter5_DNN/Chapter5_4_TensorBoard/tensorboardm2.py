...
def build_model(num_features: int, num_classes: int) -> Sequential:
    ...
    model = Sequential()
    model.add(Dense(units=2000, kernel_initializer=init_w, bias_initializer=init_b, input_shape=(num_features,)))
    model.add(Activation("elu"))
    model.add(Dense(units=1000, kernel_initializer=init_w, bias_initializer=init_b))
    model.add(Activation("elu"))
    model.add(Dense(units=500, kernel_initializer=init_w, bias_initializer=init_b))
    model.add(Activation("elu"))
